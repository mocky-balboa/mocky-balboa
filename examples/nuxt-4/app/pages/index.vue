...
/** biome-ignore-all lint/correctness/noUnusedImports: nuxt */
...
// biome-ignore lint/correctness/noUnusedVariables: nuxt
...
const getTrainingDisplayData = () => {
	...
	return [
		...Object.entries(data.trainingRegime.routine).map(([label, value]) => ({
			id: label,
			label: label,
			value: value,
		})),
