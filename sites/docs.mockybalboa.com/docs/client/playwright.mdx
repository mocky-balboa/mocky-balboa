...
1. See [the client guide](../client-guide/client) for more information on how you can mock server-side network requests from directly within your Playwright tests.
