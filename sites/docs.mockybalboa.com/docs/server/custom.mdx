...
See [@mocky-balboa/vite plugin API reference](https://api-reference.mockybalboa.com/interfaces/_mocky-balboa_vite.MockyBalboaVitePluginOptions) for available options.
