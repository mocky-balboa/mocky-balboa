...
import { ErrorRouteResponse, FallbackRouteResponse, PassthroughRouteResponse, type FulfillRouteResponse } from "./shared-types.js";
  ...
  async fetch({
    ...
    while (attempts < maxRetries) {
      ...
      try {
        ...
        logger.error(`Error fetching ${newRequest.method} ${newRequest.url}`, error);
      } finally {
        attempts++;
      }
    }
